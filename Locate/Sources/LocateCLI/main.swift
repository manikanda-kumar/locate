...
enum LocateCLI {
    ...
    private static func runBuildIndex(options: BuildIndexOptions) async throws {
    ...
    private static func runSearch(options: SearchOptions) async throws {
        let manager = try DatabaseManager(path: options.databasePath)
    ...
    private static func parseBuildIndexOptions(_ args: [String]) throws -> BuildIndexOptions {
        var rootPath: String?
        var batchSize = 500
    ...
    private static func parseSearchOptions(_ args: [String]) throws -> SearchOptions {
        var query: String?
    ...
    private static func parseInt64(token: String, value: String?) throws -> Int64 {
